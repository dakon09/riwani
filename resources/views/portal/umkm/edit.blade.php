    ...
    <form action="{{ route('portal.profile.update') }}" method="POST" class="form">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div class="d-flex align-items-center">
                <a href="{{ route('portal.profile') }}" class="btn btn-sm btn-icon btn-light me-3">
                    <i class="ki-duotone ki-arrow-left fs-2">
                        <span class="path1"></span>
                        <span class="path2"></span>
                    </i>
                </a>
                <h2 class="fw-bold fs-2 mb-0">Edit Profil</h2>
            </div>
        </div>
        <!--end::Toolbar-->
                ...
                <div class="card-body pt-0">
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" name="username" class="form-control form-control-solid"
                            value="{{ old('username', $data->user->username ?? '') }}" placeholder="Masukkan username"
                            required>
                        @error('username')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
