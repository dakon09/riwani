    ...
    <div class="card card-flush">
        ...
        <div class="card-header">
            <div class="card-title">
                <h2 class="fw-bold">Edit UMKM - {{ $data->nama_usaha }}</h2>
            </div>
        ...
        <!--begin::Card body-->
        <div class="card-body">
            <form action="{{ route('master.umkm.update', $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="fv-row mb-7">
                    ...
                    <select name="jenis_usaha" class="form-select form-select-solid" data-control="select2"
                        ...
                        <option value="Jasa" {{ old('jenis_usaha', $data->jenis_usaha) == 'Jasa' ? 'selected' : '' }}>Jasa
                        </option>
                        <option value="Dagang" {{ old('jenis_usaha', $data->jenis_usaha) == 'Dagang' ? 'selected' : '' }}>
                            Dagang</option>
                    ...
                    <div class="col-md-4 fv-row mb-7 mb-md-0">
                        ...
                        <select name="kecamatan_id" id="kecamatan_id" class="form-select form-select-solid"
                            ...
                            @if($data->kecamatan_id)
                                <option value="{{ $data->kecamatan_id }}" selected>{{ $data->district->name ?? '' }}</option>
                            @endif
                        </select>
                        @error('kecamatan_id')
                            <div class="text-danger mt-2">{{ $message }}</div>
                ...
                <div class="fv-row mb-7">
                    ...
                    <select name="status_umkm" class="form-select form-select-solid" data-control="select2"
                        ...
                        <option value="DRAFT" {{ old('status_umkm', $data->status_umkm) == 'DRAFT' ? 'selected' : '' }}>DRAFT
                        </option>
                        ...
                        <option value="ACTIVE" {{ old('status_umkm', $data->status_umkm) == 'ACTIVE' ? 'selected' : '' }}>
                            ACTIVE</option>
                        <option value="INACTIVE" {{ old('status_umkm', $data->status_umkm) == 'INACTIVE' ? 'selected' : '' }}>
                            INACTIVE</option>
                    </select>
                    @error('status_umkm')
                        <div class="text-danger mt-2">{{ $message }}</div>
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="email" name="email" class="form-control form-control-solid"
                            value="{{ old('email', $data->email) }}" placeholder="email@example.com">
                        @error('email')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
