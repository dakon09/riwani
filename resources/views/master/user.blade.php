                ...
                <div class="d-flex justify-content-between mb-5">
                    <div class="d-flex align-items-center position-relative my-1">
                        <i class="ki-duotone ki-magnifier fs-3 position-absolute ms-5"><span class="path1"></span><span
                                class="path2"></span></i>
                        <input type="text" id="search_user_name" data-kt-docs-table-filter="search"
                            class="form-control form-control-solid w-250px ps-14" placeholder="Cari User">
                    </div>
                            ...
                            <div class="mb-7">
                                ...
                                <div class="fv-row">
                                    ...
                                    <select class="form-select form-select-solid" name="role" id="role"
                                        ...
                                        data-dropdown-parent="#kt_modal_add_user" data-placeholder="Pilih Role">
                                        <option></option>
                            ...
                            <div class="mb-7">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" name="name_edit" id="name_edit"
                                        class="form-control form-control-solid" placeholder="Masukkan nama lengkap user" />
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Email</label>
                                    <input type="email" name="email_edit" id="email_edit"
                                        class="form-control form-control-solid" placeholder="contoh@domain.com" />
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Username</label>
                                    <input type="text" name="username_edit" id="username_edit"
                                        class="form-control form-control-solid" placeholder="Masukkan username unik" />
                                </div>
                            </div>
                            <div class="separator separator-dashed my-9"></div>
                            ...
                            <div class="mb-7">
                                ...
                                <div class="row" data-kt-password-meter="true">
                                    <div class="col-md-6 fv-row mb-7">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-solid" type="password"
                                                placeholder="Masukkan password" name="password_edit" id="password_edit"
                                                autocomplete="off" />
                                            <span
                                                class="btn btn-sm btn-icon position-absolute translate-middle top-50 end-0 me-n2"
                                                data-kt-password-meter-control="visibility">
                                    ...
                                    <div class="col-md-6 fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Konfirmasi Password</label>
                                        <input class="form-control form-control-solid" type="password"
                                            placeholder="Ulangi password" name="password_confirmation_edit"
                                            id="password_confirmation_edit" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Role</label>
                                    <select class="form-select form-select-solid" name="role_id" id="role_edit"
                                        data-control="select2" data-hide-search="true"
                                        data-dropdown-parent="#kt_modal_edit_user" data-placeholder="Pilih Role">
                                        <option></option>
                                        @foreach ($roles as $item)
                                            <option value="{{ $item->name }}">{{ $item->name }}</option>
                                        @endforeach
