...
Route::name('master.')->prefix('master')->middleware(['auth:web', config('jetstream.auth_session'), 'verified'])->group(function () {
    // user
    Route::middleware('can.access:master_user')
        ->name('user.')
    ...
    // role
    Route::middleware('can.access:master_role')
        ->name('role.')
    ...
    // permission
    Route::middleware('can.access:master_permission')
        ->name('permission.')
    ...
    Route::name('umkm.')->controller(UmkmController::class)->prefix('umkm')->group(function () {
        ...
        Route::middleware('can.access:umkm_index')->group(function () {
        ...
        // Create
        Route::middleware('can.access:umkm_create')->group(function () {
            Route::get('/create', 'create')->name('create');
            Route::post('/', 'store')->name('store');
        });

        // Edit
        Route::middleware('can.access:umkm_edit')->group(function () {
        ...
        // Delete
        Route::middleware('can.access:umkm_delete')->group(function () {
            Route::delete('/{umkm}', 'destroy')->name('destroy');
        });

        // Import
        Route::middleware('can.access:umkm_import')->group(function () {
